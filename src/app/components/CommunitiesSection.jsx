...
import { FaMapMarkerAlt, FaHome, FaBuilding, FaTree, FaSwimmingPool, FaInfoCircle, FaChevronRight, FaPhone, FaEnvelope, FaWhatsapp } from "react-icons/fa";
...
const communities = [
  {
    id: 1,
    name: "Palm Jumeirah",
    description: "Iconic man-made island featuring luxury villas and apartments with private beach access and stunning sea views.",
  ...
  },
  {
    id: 2,
    name: "Downtown Dubai",
    description: "Home to Burj Khalifa and Dubai Mall, offering premium apartments with world-class amenities in the heart of the city.",
  ...
  },
  {
    id: 3,
    name: "Dubai Marina",
    description: "Stunning waterfront community with luxury high-rise apartments, yacht club access, and vibrant promenade living.",
  ...
  },
  {
    ...
    description: "Exclusive desert-themed villa community with championship golf course, equestrian center and family-friendly amenities.",
  ...
  },
  {
    ...
    description: "Prestigious community with lush parks, championship golf course and luxury homes offering modern family living.",
...
export default function CommunitiesSection() {
  ...
  const prevCommunity = () => {
    setActiveCommunity((prev) => (prev - 1 + communities.length) % communities.length);
    // Reset all modals when changing communities
    setShowVirtualTour(false);
    setShowContactModal(false);
    setSelectedFeature(null);
  ...
  useEffect(() => {
    if (isHovering || showVirtualTour || showContactModal || selectedFeature || showImageZoom) return;
  ...
  }, [activeCommunity, isHovering, showVirtualTour, showContactModal, selectedFeature, showImageZoom]);
     ...
     <div className="absolute inset-0 opacity-5">
      ...
      <div className="absolute top-1/4 right-[5%] z-10">
        <motion.div
          ...
          whileHover={{ scale: 1.1, backgroundColor: "rgba(125, 116, 96, 0.5)" }}
          whileTap={{ scale: 0.9 }}
          animate={{ 
            y: [0, -10, 0],
          }}
      ...
      <motion.div 
        style={{ opacity }}
        className="w-[90vw] md:w-[85vw] mx-auto px-4 sm:px-6 lg:px-8 relative z-10"
      >
        {/* Section header */}
        <motion.div 
        ...
        >
          ...
          <p className="text-xl text-earth-300 max-w-2xl mx-auto">
            Discover Dubai's most prestigious neighborhoods and find your perfect home
          </p>
        </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="relative w-full h-80 rounded-2xl overflow-hidden shadow-xl border border-earth-700 group">
                          ...
                          <div className="absolute inset-0">
                            ...
                            <motion.button
                              ...
                              whileHover={{ scale: 1.1 }}
                              whileTap={{ scale: 0.9 }}
                              onClick={() => window.open(community.mapLink, '_blank')}
                            ...
                            <div className="flex gap-4 mt-3">
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-white font-medium">{community.properties}</p>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-white font-medium">{community.priceRange}</p>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            {community.features.map((feature, idx) => (
                              ...
                              >
                                <div className="w-10 h-10 rounded-full bg-earth-700 flex items-center justify-center mr-3 group-hover:bg-earth-600 transition-colors duration-300">
                                  {idx === 0 && <FaSwimmingPool className="text-earth-200 group-hover:text-white transition-colors duration-300" />}
                                  {idx === 1 && <FaTree className="text-earth-200 group-hover:text-white transition-colors duration-300" />}
                                  {idx === 2 && <FaBuilding className="text-earth-200 group-hover:text-white transition-colors duration-300" />}
                                </div>
                                <div className="flex-1">
                                  <p className="text-earth-200 font-medium group-hover:text-white transition-colors duration-300">{feature}</p>
                                </div>
                      ...
                      <div className="lg:col-span-7">
                        <div className="bg-earth-800/80 backdrop-blur-sm rounded-2xl border border-earth-700 p-6 sm:p-8 shadow-lg h-full">
                          <h3 className="text-3xl font-semibold mb-2 text-white">{community.name}</h3>
                          <div className="flex items-center mb-4">
                            <div className="h-0.5 w-8 bg-earth-500 mr-2"></div>
                            <span className="text-earth-300 text-sm">Premium Community</span>
                          </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                              ...
                              >
                                <div className="w-8 h-8 rounded-full bg-earth-700 flex items-center justify-center mt-1 mr-3 group-hover:bg-earth-600 transition-colors duration-300">
                                  <span className="text-earth-200 text-xs font-medium group-hover:text-white transition-colors duration-300">01</span>
                                </div>
                                <div>
                                  <h5 className="font-medium text-earth-100 mb-1 group-hover:text-white transition-colors duration-300">Strategic Location</h5>
                                  <p className="text-sm text-earth-300 group-hover:text-earth-200 transition-colors duration-300">
                                    {community.name === "Palm Jumeirah" && "Iconic man-made island with stunning sea views"}
                                    {community.name === "Downtown Dubai" && "Heart of the city near Burj Khalifa"}
                                    {community.name === "Dubai Marina" && "Waterfront community with yacht harbor"}
                                    {community.name === "Arabian Ranches" && "Serene desert-themed community"}
                                    {community.name === "Dubai Hills Estate" && "Prestigious area with golf course views"}
                                  </p>
                                </div>
                              </motion.div>
                              ...
                              >
                                <div className="w-8 h-8 rounded-full bg-earth-700 flex items-center justify-center mt-1 mr-3 group-hover:bg-earth-600 transition-colors duration-300">
                                  <span className="text-earth-200 text-xs font-medium group-hover:text-white transition-colors duration-300">02</span>
                                </div>
                                <div>
                                  <h5 className="font-medium text-earth-100 mb-1 group-hover:text-white transition-colors duration-300">Connectivity</h5>
                                  <p className="text-sm text-earth-300 group-hover:text-earth-200 transition-colors duration-300">
                                    {community.name === "Palm Jumeirah" && "30 min to Dubai Airport, 15 min to Dubai Marina"}
                                    {community.name === "Downtown Dubai" && "15 min to Dubai Airport, central location"}
                                    {community.name === "Dubai Marina" && "35 min to Dubai Airport, near JBR Beach"}
                                    {community.name === "Arabian Ranches" && "25 min to Downtown, near Dubai Autodrome"}
                                    {community.name === "Dubai Hills Estate" && "20 min to Downtown, near Al Khail Road"}
                                  </p>
                                </div>
                              </motion.div>
                              ...
                              >
                                <div className="w-8 h-8 rounded-full bg-earth-700 flex items-center justify-center mt-1 mr-3 group-hover:bg-earth-600 transition-colors duration-300">
                                  <span className="text-earth-200 text-xs font-medium group-hover:text-white transition-colors duration-300">03</span>
                                </div>
                                <div>
                                  <h5 className="font-medium text-earth-100 mb-1 group-hover:text-white transition-colors duration-300">Lifestyle</h5>
                                  <p className="text-sm text-earth-300 group-hover:text-earth-200 transition-colors duration-300">
                                    {community.name === "Palm Jumeirah" && "Luxury beachfront living with 5-star hotels"}
                                    {community.name === "Downtown Dubai" && "Urban lifestyle with shopping and dining"}
                                    {community.name === "Dubai Marina" && "Vibrant waterfront lifestyle with cafes"}
                                    {community.name === "Arabian Ranches" && "Family-friendly with equestrian center"}
                                    {community.name === "Dubai Hills Estate" && "Modern luxury with parks and retail"}
                                  </p>
                                </div>
                              </motion.div>
                              ...
                              >
                                <div className="w-8 h-8 rounded-full bg-earth-700 flex items-center justify-center mt-1 mr-3 group-hover:bg-earth-600 transition-colors duration-300">
                                  <span className="text-earth-200 text-xs font-medium group-hover:text-white transition-colors duration-300">04</span>
                                </div>
                                <div>
                                  <h5 className="font-medium text-earth-100 mb-1 group-hover:text-white transition-colors duration-300">Investment Value</h5>
                                  <p className="text-sm text-earth-300 group-hover:text-earth-200 transition-colors duration-300">
                                    {community.name === "Palm Jumeirah" && "Premium ROI with consistent appreciation"}
                                    {community.name === "Downtown Dubai" && "High rental yields in central location"}
                                    {community.name === "Dubai Marina" && "Strong rental demand from professionals"}
                                    {community.name === "Arabian Ranches" && "Stable investment with family appeal"}
                                    {community.name === "Dubai Hills Estate" && "Growing area with appreciation potential"}
                                  </p>
                                </div>
                              </motion.div>
                            </div>
                          ...
                          <div className="flex flex-wrap gap-3 mt-8">
                            ...
                            >
                              ...
                              >
                                All Communities
                                <BsArrowRight size={14} className="group-hover:translate-x-1 transition-transform duration-300" />
                              </Link>
                            </motion.div>
                          </div>
                        </div>
          ...
          >
            ...
            >
              <div className="p-4 flex justify-between items-center border-b border-earth-700">
                <h3 className="text-xl font-medium text-white">Virtual Tour - {communities[activeCommunity].name}</h3>
                <button 
              ...
              <div className="p-6">
                <p className="text-earth-200 mb-4">Explore {communities[activeCommunity].name} in immersive 360° view. Navigate through the community to experience the lifestyle and amenities.</p>
      ...
      <AnimatePresence>
        {showContactModal && (
          ...
          >
            ...
            >
              <div className="p-4 flex justify-between items-center border-b border-earth-700">
                <h3 className="text-xl font-medium text-white">Contact Specialist - {communities[activeCommunity].name}</h3>
                <button 
              ...
              <div className="p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h4 className="text-white font-medium">Community Specialist</h4>
                    <p className="text-earth-300 text-sm">Available 24/7 for inquiries</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <a 
                    href={`https://wa.me/${communities[activeCommunity].contactAgent.replace(/\+/g, '')}`}
                    target="_blank"
      ...
      <AnimatePresence>
        {selectedFeature && (
          ...
          >
            ...
            >
              <div className="p-4 flex justify-between items-center border-b border-earth-700">
                <h3 className="text-xl font-medium text-white">{selectedFeature.feature} - {communities[activeCommunity].name}</h3>
                <button 
              ...
              <div className="p-6">
                <div className="mb-4">
                  <div className="w-16 h-16 rounded-full bg-earth-700 flex items-center justify-center mx-auto mb-4">
                    {selectedFeature.idx === 0 && <FaSwimmingPool className="text-white text-2xl" />}
                    {selectedFeature.idx === 1 && <FaTree className="text-white text-2xl" />}
                    {selectedFeature.idx === 2 && <FaBuilding className="text-white text-2xl" />}
                  </div>
                  
                  <p className="text-earth-200 mb-4">
                    {selectedFeature.feature === "Beachfront" && "Private beach access with pristine white sand and crystal-clear waters. Enjoy water sports, sunbathing, and breathtaking sunsets right at your doorstep."}
                    {selectedFeature.feature === "Luxury Hotels" && "World-class 5-star hotels offering premium dining, spa services, and exclusive beach clubs accessible to residents."}
                    {selectedFeature.feature === "Fine Dining" && "Michelin-star restaurants and gourmet dining options featuring international cuisines prepared by renowned chefs."}
