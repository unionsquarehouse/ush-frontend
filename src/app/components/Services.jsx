...
const services = [
  { 
    ...
    icon: FaBuilding,
    features: ['Pre-launch access', 'Developer partnerships', 'Payment plan options'],
...
export default function Services() {
  ...
  return (
    <section id="services" className="pb-32 relative overflow-hidden" ref={sectionRef}>
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 backface-hidden rounded-xl overflow-hidden shadow-xl rotate-y-180">
                  ...
                  {/* Main content */}
                  <div className={`absolute inset-0 m-[2px] bg-gradient-to-br ${service.color} rounded-[10px] overflow-hidden z-10 p-6 flex flex-col`}>
                    ...
                    <p className="text-earth-50/90 mb-6">
                      {service.desc}
                    </p>
                    
                    <div className="space-y-4 mb-6">
                      <h5 className="text-white text-lg font-medium">Key Features:</h5>
                      {service.features.map((feature, i) => (
                        ...
                        >
                          ...
                          <span className="text-earth-50/80">
                            {feature}
                          </span>
                        </div>
                      ))}
