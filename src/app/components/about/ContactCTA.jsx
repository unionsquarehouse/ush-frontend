      ...
      <div className="w-[90vw] md:w-[85vw] lg:w-[80vw] xl:w-[70vw] 2xl:w-[75vw] mx-auto">
        ...
        >
          ...
          <p className="text-xl text-earth-100 mb-12 max-w-3xl mx-auto">
            For more information about how we can help you with real estate,
            please contact one of our advisers with your requirements.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto mb-12">
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-tl-[2rem] rounded-br-[2rem] p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                <FaPhone className="text-3xl text-brand mb-4 mx-auto group-hover:scale-110 transition-transform duration-300" />
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-tl-[2rem] rounded-br-[2rem] p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                <FaEnvelope className="text-3xl text-brand mb-4 mx-auto group-hover:scale-110 transition-transform duration-300" />
