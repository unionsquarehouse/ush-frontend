  ...
  const achievements = [
    {
      icon: FaAward,
      title: "Award-Winning",
      description: "Multiple awards from Emaar, Dubai Properties and Nshama",
      stat: "15+",
      statLabel: "Awards"
    },
    {
      ...
      <div className="w-[90vw] md:w-[85vw] lg:w-[80vw] xl:w-[70vw] 2xl:w-[75vw] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-6xl text-black mb-6">
            ...
            <div className="bg-gradient-to-r from-brand to-white rounded-tl-[2rem] rounded-br-[2rem] p-6 ">
              <p className="">
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-brand to-brand-hover flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="text-xl text-earth-600 mb-2">{achievement.statLabel}</div>
                  <h4 className="text-2xl font-bold text-earth-800 mb-2">{achievement.title}</h4>
                  <p className="text-xl text-earth-600 leading-relaxed">{achievement.description}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
