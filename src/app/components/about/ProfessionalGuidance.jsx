  ...
  const achievements = [
    {
      ...
      title: "Award-Winning",
      description:
        "Multiple awards from Emaar, Dubai Properties, Deyaar and Nshama",
      stat: "15+",
      statLabel: "Awards",
    },
    {
      ...
      title: "Expert Team",
      description:
        "Multi-lingual, multi-cultural team of certified professionals",
      stat: "50+",
      statLabel: "Agents",
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-earth-600 leading-relaxed mb-8">
              Our professional team of agents have been trained to deliver sound
              advice and guidance to clients as well as prospects. We have
              developed a multi-lingual, multi-cultural team of agents
              specializing in every other freehold area in Dubai.
            </p>

            <p className="text-lg text-earth-600 leading-relaxed mb-8">
              Looking for advice on where to invest / reside? We can connect you
              to one of our agents fit to satisfactorily take care of your
              property needs in Dubai. Our agents have all the knowledge there
            ...
            <div className="bg-gradient-to-r from-[#ac895e] to-[#876F4E] rounded-tl-[2rem] rounded-br-[2rem] p-6 text-white">
              <p className="text-lg font-medium">
                Union Square House has won awards from all the well-known master
                developers in Dubai, including{" "}
                <strong>Emaar, Dubai Properties, Deyaar and Nshama</strong> –
                multiple times – in the last few years alone.
              </p>
            </div>
          </motion.div>
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                <div className="bg-earth-50 rounded-tl-[1.5rem] rounded-br-[1.5rem] p-6 border border-earth-200 hover:shadow-lg transition-all duration-300">
                  ...
                  <h4 className="text-lg font-bold text-earth-800 mb-2">
                    {achievement.title}
                  </h4>
