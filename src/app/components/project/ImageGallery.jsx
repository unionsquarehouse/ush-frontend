    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[500px]">
        ...
        >
          ...
          <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm text-[#866c4c] px-4 py-2 font-sans font-medium shadow-lg">
            <CameraIcon className="inline w-4 h-4 mr-2" />
            1 / {galleryImages.length}
          </div>
          <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-sm text-[#866c4c] p-3  opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-lg">
