      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        {showItemsPerPageSelect && onItemsPerPageChange && (
          <div className="flex items-center gap-1">
            <label htmlFor="itemsPerPage" className="text-brand text-sm whitespace-nowrap">
              Items per page:
            </label>
            <select
              id="itemsPerPage"
      ...
      {totalPages > 1 && (
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            className="w-10 h-10 rounded-tl-xl rounded-br-xl flex items-center justify-center border border-[#876F4E] text-[#ac895e] hover:bg-[#876F4E] hover:text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-[#ac895e]"
                ...
                <motion.button
                  ...
                  className={`min-w-[40px] h-10 rounded-tl-xl rounded-br-xl flex items-center justify-center transition-colors ${
                    currentPage === page
                      ...
                      : "border border-[#876F4E] text-[#ac895e] hover:bg-[#876F4E] hover:text-white"
                  }`}
