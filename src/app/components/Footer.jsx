...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      ...
      {/* Main Footer Content */}
      <div className="relative w-[90vw] md:w-[85vw] mx-auto py-16 md:py-20 text-white">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4 space-y-8">
            ...
            >
              ...
              <p className="text-earth-300 leading-relaxed">
                Dubai's multi-award winning real estate agency, recognized for excellence in luxury property sales and leasing across the UAE's most prestigious communities.
              </p>
              
              {/* Awards badges */}
              <div className="flex flex-wrap gap-3 pt-2">
                {[1, 2, 3].map((badge) => (
                  <div key={badge} className="w-12 h-12 bg-earth-700/50 backdrop-blur-sm rounded-full flex items-center justify-center border border-earth-600/50">
              ...
              {/* Social Media */}
              <div className="pt-2">
                <h5 className="text-earth-200 text-sm font-medium mb-4">Connect With Us</h5>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h4 className="text-lg font-medium mb-6 text-earth-100">Contact Us</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-earth-700/30 backdrop-blur-sm rounded-xl p-4 border border-earth-600/30 hover:bg-earth-700/50 transition-colors duration-300 group">
                <div className="flex">
                  ...
                  <div>
                    <h5 className="text-earth-100 font-medium mb-1">Our Location</h5>
                    <p className="text-earth-300 text-sm">Business Bay, Dubai, United Arab Emirates</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-earth-700/30 backdrop-blur-sm rounded-xl p-4 border border-earth-600/30 hover:bg-earth-700/50 transition-colors duration-300 group">
                <div className="flex">
                  ...
                  <div>
                    ...
                    <a href="tel:+97144589090" className="text-earth-300 text-sm hover:text-earth-100 transition-colors duration-300">
                      +971 4 458 9090
                    </a>
                  </div>
                </div>
              ...
              <div className="bg-earth-700/30 backdrop-blur-sm rounded-xl p-4 border border-earth-600/30 hover:bg-earth-700/50 transition-colors duration-300 group">
                <div className="flex">
                  ...
                  <div>
                    <h5 className="text-earth-100 font-medium mb-1">Email Us</h5>
                    <a href="mailto:info@ushre.com" className="text-earth-300 text-sm hover:text-earth-100 transition-colors duration-300">
                      info@ushre.com
                    </a>
                  </div>
                </div>
        ...
        >
          <div className="grid md:grid-cols-5 gap-6 items-center">
            <div className="md:col-span-2">
              <h4 className="text-lg font-medium text-earth-100 mb-2">Stay Updated</h4>
              <p className="text-earth-300 text-sm">Subscribe to our newsletter for exclusive property updates and market insights</p>
            </div>
      ...
      <div className="relative border-t border-earth-700/70">
        <div className="w-[90vw] md:w-[85vw] mx-auto py-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-earth-400 text-sm flex space-x-6">
            <Link href="/privacy-policy" className="hover:text-earth-200 transition-colors duration-300">
              Privacy Policy
            </Link>
            <Link href="/terms-of-service" className="hover:text-earth-200 transition-colors duration-300">
              Terms of Service
            </Link>
            <Link href="/sitemap" className="hover:text-earth-200 transition-colors duration-300">
              Sitemap
            </Link>
          </div>
        </div>
