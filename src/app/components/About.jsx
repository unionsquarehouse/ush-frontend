...
const FeatureCard = ({ icon: Icon, title, description }) => {
  ...
  return (
    ...
    >
      ...
      <h4 className="text-xl font-semibold text-earth-800 mb-3 relative z-10">
        {title}
      </h4>
  ...
  const timelineItems = [
    {
      ...
      description: "Union Square House was established in Dubai",
    },
    {
      year: "2015",
      title: "Market Leader",
      description: "Became one of Dubai's top real estate agencies",
    },
    {
      year: "2018",
      title: "International Expansion",
      description: "Opened offices in key global markets",
    },
    {
      year: "2022",
      title: "Digital Transformation",
      description: "Launched innovative property tech solutions",
    },
  ];
          ...
          {timelineItems.map((item, index) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-earth-500">
                  {item.year}
                </span>
                <h4 className="text-xl font-semibold text-earth-800 mb-1">
                  {item.title}
                </h4>
  ...
  const features = [
    {
      ...
      icon: FaUsers,
      description:
        "Our team of seasoned professionals provides unparalleled market insights",
    },
    {
      title: "Premium Portfolio",
      icon: FaBuilding,
      description:
        "Access to Dubai's most exclusive properties and developments",
    },
    {
      title: "Investment Success",
      icon: FaChartLine,
      description:
        "Proven track record of maximizing returns for our investors",
    },
  ];
        ...
        >
          ...
          >
            ...
            <p className="text-earth-600 text-center italic max-w-2xl text-lg">
              Dubai's most trusted real estate agency with over a decade of
              excellence
            </p>
          </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-20 items-center">
                  <motion.div
                    ...
                    onClick={() =>
                      handleShowModal({
                        ...
                        description:
                          "Our state-of-the-art headquarters in Dubai, designed to provide an exceptional client experience with cutting-edge technology and luxurious amenities.",
                      })
                    }
                  >
                    ...
                    <svg
                      className="absolute top-0 left-0 w-full h-full z-20 opacity-30 group-hover:opacity-60 transition-opacity duration-500"
                      viewBox="0 0 100 100"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-earth-900/70 via-earth-900/40 to-transparent p-6 z-20 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <p className="text-white/80 text-sm">
                        Our headquarters in Dubai, designed to provide an
                  ...
                  >
                    ...
                    <p className="text-lg text-earth-600 leading-relaxed">
                      With over a decade of experience in Dubai's premium real
                      estate market, we've established ourselves as a trusted
                      partner for investors and homeowners alike, managing a
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-6">
                      {[
                        ...
                        <div
                          key={i}
                          className="bg-earth-50/80 backdrop-blur-sm rounded-lg p-4 border border-earth-100"
                        >
                          <div className="text-2xl font-bold text-earth-800 mb-1 font-mono">
                            {stat.value}
                          </div>
                    ...
                    {[
                      {
                        ...
                        title: "Company Founded",
                        description:
                          "Union Square House was established in Dubai with a vision to transform the luxury real estate experience.",
                      ...
                      },
                      {
                        ...
                        title: "Market Leader",
                        description:
                          "Became one of Dubai's top real estate agencies with a portfolio exceeding AED 2 billion.",
                      ...
                      },
                      {
                        ...
                        title: "International Expansion",
                        description:
                          "Opened offices in key global markets and established partnerships with international developers.",
                      ...
                      },
                      {
                        ...
                        title: "Digital Transformation",
                        description:
                          "Launched innovative property tech solutions to enhance client experience and streamline transactions.",
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <p className="text-earth-500 font-medium relative z-10">
                  {stat.text}
                </p>
